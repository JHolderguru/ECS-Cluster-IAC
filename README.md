...
#### Retrieve the key with the following command. ``` gpg --keyserver hkp://keys.gnupg.net --recv BCE9D9A42D51784F``` or Create a file with the following contents of the Amazon ECS PGP public key and then import it.
```
